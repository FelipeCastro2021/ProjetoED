...
public class Entrar extends JFrame {
	...
	public Entrar() {
		...
		lblMensagemExpo2.setFont(new Font("Arial", Font.PLAIN, 10));
		...
		tfSenha.setFont(new Font("Arial", Font.BOLD, 12));
